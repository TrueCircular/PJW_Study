...
#define GAME_WINDOW(s,x,y) Sample demo;demo.SetWindow(hInstance,L#s,x,y);demo.Run();return 0;
#define GAME_END    }
...
{
	if (pObj)
		pObj->SetPrivateData(WKPDID_D3DDebugObjectName, text.size(), text.c_str());
}
